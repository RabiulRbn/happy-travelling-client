...
const MyOrders = () => {
    ...
    const { user } = useAuth();
    useEffect(() => {
        fetch("https://howling-labyrinth-06347.herokuapp.com/orderedProduct")
    ...
    return (
        <div className="container mt-3 text-center">
            ...
            <br />
            <br />
            <h3 className="text-center">Congratulations {user.displayName}! You'r have {newOrders.length} orders</h3><br />
            {
                newOrders.length === 0 &&
